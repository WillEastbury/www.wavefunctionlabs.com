/*
 * micro-brotli: minimal RFC 7932 (Brotli) encoder + decoder for picoweb.
 *
 ...
 *
 * The decoder reads the subset this encoder emits (plus uncompressed
 * meta-blocks). The encoder only runs at startup (never on the hot path).
 */
